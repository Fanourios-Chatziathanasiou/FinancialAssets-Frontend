...
const FinancialChart = ({ dateTimeFormat, height, margin, priceDisplayFormat, ratio, width }) => {
	...
	return (
		...
		>
			...
			<Chart id={2} yExtentsCalculator={yExtentsCalculator}>
				...
				<CandlestickSeries />
				<OHLCTooltip origin={[8, 16]} textFill={openCloseColor} className="react-no-select" />
...
export const PriceChart = withSize({ style: { width: "100%", height: "100%" } })(withDeviceRatio()(FinancialChart));
