	...
	switch (true) {
		...
		case props.name.startsWith("Moving Average Convergence Divergence"):
			return (
				<>
					<div className="p-6 ">
						<label htmlFor="fastEMA" className="block  text-sm font-medium text-gray-900 dark:text-gray-300">
							fast EMA Length
						</label>
						<input
							type="number"
							id="fastEMA"
							className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
							placeholder={props.fastEMA}
							defaultValue={props.fastEMA}
							min={1}
							max={500}
							required
							onChange={allFunctions.handleChangeNumber}
					...
					<div className="p-6 ">
						<label htmlFor="slowEMA" className="block  text-sm font-medium text-gray-900 dark:text-gray-300">
							slow EMA length
						</label>
						<input
							type="number"
							...
							className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
							min={1}
							defaultValue={props.slowEMA}
							placeholder={props.slowEMA}
							max={500}
							required
							onChange={allFunctions.handleChangeNumber}
						/>
					...
					<div className="p-6 ">
						<label htmlFor="signalLine" className="  text-sm font-medium text-gray-900 dark:text-gray-300">
							signal line Length
						</label>
						<input
							type="number"
							...
							className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
							min={1}
							defaultValue={props.signalLine}
							placeholder={props.signalLine}
							max={100}
							maxLength={3}
							required
							onChange={allFunctions.handleChangeNumber}
